...
$trdr = (string) $order->get_meta( self::ORDER_META_TRDR, true );
        ...
        protected function ensure_registered_order_customer_trdr( WC_Order $order, $customer_id ) {
            ...
            $response = $this->set_customer_data_with_code_seed_fallback( $payload, $order );
         ...
         * @return array<string,mixed>
         */
        protected function set_customer_data_with_code_seed_fallback( array $payload, WC_Order $order ) {
            try {
            ...
            $this->log_order_event(
                ...
                $this->build_order_event_context( $order, array( 'payload' => $code_less_payload ) )
            );
